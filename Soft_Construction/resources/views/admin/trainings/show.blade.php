...
<header class="header">
    <div class="header-content">
        <div>
            <h1><i class="fas fa-dumbbell"></i> Training Program Details</h1>
            <p>View comprehensive information about this training program</p>
        </div>
    ...
    <div class="training-detail-card">
        <div class="card-body">
            ...
            <div class="training-header">
                @if($training->image)
                <div class="training-image-container" onclick="openModal('{{ asset('storage/' . $training->image) }}')">
                    <img src="{{ asset('storage/' . $training->image) }}" class="training-image" alt="Training Image">
            ...
            <div class="detail-section">
                <div class="detail-grid">
                    ...
                    <div class="detail-item">
                        ...
                        <p class="detail-value">{{ $training->order }}</p>
                    </div>
                    ...
                    <div class="detail-item">
                        ...
                        <p class="detail-value">{{ $training->slug }}</p>
                    </div>
                    ...
                    <div class="detail-item">
                        ...
                        <p class="detail-value">{{ $training->created_at->format('M d, Y H:i') }}</p>
                    </div>
                    ...
                    <div class="detail-item">
                        ...
                        <p class="detail-value">{{ $training->updated_at->format('M d, Y H:i') }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="action-buttons">
                <a href="{{ route('admin.trainings.edit', $training->id) }}" class="btn-action btn-edit">
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const imageContainer = document.querySelector('.training-image-container');
        if (imageContainer) {
    ...
    style.textContent = `
        ...
        .training-image-container:hover .image-label {
            opacity: 1;
        }
