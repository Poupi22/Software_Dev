...
<div class="container-fluid">
    ...
    <div class="header">
        <div class="header-content">
            <div>
                <h1><i class="fas fa-info-circle"></i> Create About Section</h1>
                <p>Add new about section content to showcase your company</p>
            </div>
    ...
    <div class="container">
        <div class="card">
            <form action="{{ route('admin.abouts.store') }}" method="POST" enctype="multipart/form-data" class="about-form">
                @csrf
                ...
                <div class="form-grid">
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-group floating">
                            <input type="text" class="form-control" id="subtitle" name="subtitle" value="{{ old('subtitle') }}" placeholder=" " required>
                            <label for="subtitle">Subtitle *</label>
                            <div class="highlight"></div>
                        </div>

                        <div class="form-group floating">
                            <textarea class="form-control" id="description1" name="description1" placeholder=" " rows="4" required>{{ old('description1') }}</textarea>
                            <label for="description1">First Description *</label>
                            <div class="highlight"></div>
                        </div>

                        <div class="form-group floating">
                            <textarea class="form-control" id="description2" name="description2" placeholder=" " rows="4" required>{{ old('description2') }}</textarea>
                    ...
                    <div class="form-section">
                        ...
                        <div class="experience-grid">
                            <div class="form-group floating">
                                <input type="text" class="form-control" id="experience_years" name="experience_years" value="{{ old('experience_years') }}" placeholder=" " required>
                                <label for="experience_years">Experience Years *</label>
                                <div class="highlight"></div>
                            </div>

                            <div class="form-group floating">
                                <input type="text" class="form-control" id="experience_text" name="experience_text" value="{{ old('experience_text') }}" placeholder=" " required>
                    ...
                    <div class="form-section">
                        ...
                        <div id="features-container">
                            ...
                            <div class="feature-item" data-index="0">
                                ...
                                <div class="form-group floating">
                                    <input type="text" class="form-control" name="features[0][icon]" value="{{ old('features.0.icon') }}" placeholder=" " required>
                                    <label>Icon Class (Font Awesome) *</label>
                                    <div class="highlight"></div>
                                    <small class="hint">e.g., fas fa-check, fas fa-award, fas fa-users</small>
                                </div>
                                <div class="form-group floating">
                                    <input type="text" class="form-control" name="features[0][title]" value="{{ old('features.0.title') }}" placeholder=" " required>
                                    <label>Feature Title *</label>
                                    <div class="highlight"></div>
                                </div>
                                <div class="form-group floating">
                                    <input type="text" class="form-control" name="features[0][description]" value="{{ old('features.0.description') }}" placeholder=" " required>
                ...
                <div class="form-actions">
                    <button type="submit" class="btn-submit">
                        <i class="fas fa-plus-circle"></i> Create About Section
                    </button>
...
<script>
    let featureCount = {{ count(old('features', [])) > 0 ? count(old('features', [])) : 1 }};
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Load existing features from old input if any
        @if(old('features'))
