    ...
    <div class="contact-detail-card">
        <div class="card-body">
            ...
            <div class="detail-section">
                <div class="detail-grid">
                    <div class="detail-item">
                        ...
                        <p class="detail-value">{{ $contact->address }}</p>
                    </div>
                    ...
                    <div class="detail-item">
                        ...
                        <p class="detail-value">{{ $contact->telephone }}</p>
                    </div>
                    ...
                    <div class="detail-item">
                        ...
                        <p class="detail-value">{!! nl2br(e($contact->heuredouverture)) !!}</p>
                    </div>
                    ...
                    <div class="detail-item">
                        ...
                        <p class="detail-value">{{ $contact->created_at->format('M d, Y H:i') }}</p>
                    </div>
                    ...
                    <div class="detail-item">
                        ...
                        <p class="detail-value">{{ $contact->updated_at->format('M d, Y H:i') }}</p>
                    </div>
                    ...
                    <div class="detail-item full-width">
                        ...
                        <div class="social-links">
                            @if($contact->facebook)
                                <a href="{{ $contact->facebook }}" target="_blank" class="social-icon facebook">
                                    <i class="fab fa-facebook-f"></i>
                                </a>
                            @endif
                            @if($contact->twitter)
                                <a href="{{ $contact->twitter }}" target="_blank" class="social-icon twitter">
                                    <i class="fab fa-twitter"></i>
                                </a>
                            @endif
                            @if($contact->linkedin)
                                <a href="{{ $contact->linkedin }}" target="_blank" class="social-icon linkedin">
                                    <i class="fab fa-linkedin-in"></i>
                                </a>
                            @endif
                            @if($contact->instagram)
                                <a href="{{ $contact->instagram }}" target="_blank" class="social-icon instagram">
            ...
            <div class="action-buttons">
                <a href="{{ route('admin.contacts.edit', $contact->id) }}" class="btn-action btn-edit">
