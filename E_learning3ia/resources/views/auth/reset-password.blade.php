...
<head>
    ...
    <title>Réinitialiser le mot de passe - 3IA</title>
...
<body>
    ...
    <div class="login-container slide-up">
        <div class="login-left">
            <i class="fas fa-lock ai-icon"></i>
            <h2>Réinitialiser votre mot de passe</h2>
            <p>Créez un nouveau mot de passe sécurisé pour accéder à votre compte 3IA.</p>
            <i class="fas fa-shield-alt decoration"></i>
        </div>
        ...
        <div class="login-right">
            ...
            <form method="POST" action="{{ route('password.store') }}">
                ...
                <div class="input-group">
                    ...
                    <input id="email" type="email" class="input-field" name="email" value="{{ old('email', $request->email) }}" required autofocus autocomplete="username" placeholder="Entrez votre email">
                    @error('email')
                ...
                <div class="input-group">
                    ...
                    <input id="password" type="password" class="input-field" name="password" required autocomplete="new-password" placeholder="Entrez votre nouveau mot de passe">
                    @error('password')
                        <div class="error-message">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="input-group">
                    ...
                    <input id="password_confirmation" type="password" class="input-field" name="password_confirmation" required autocomplete="new-password" placeholder="Confirmez votre nouveau mot de passe">
