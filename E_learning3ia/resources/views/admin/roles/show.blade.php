        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6">
            <div class="flex items-center mb-4 sm:mb-0">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-600">Informations détaillées sur ce rôle</p>
                </div>
            </div>
            <div class="flex space-x-3">
                <a href="{{ route('dashboard1.role.index') }}"
        ...
        <div class="bg-white rounded-xl shadow-md overflow-hidden animate-slide-up">
            <div class="p-6 sm:p-8">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <div class="mt-4 space-y-4">
                                <div>
                                    ...
                                    <p class="mt-1 text-sm font-medium text-gray-900">{{ $role->id }}</p>
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <p class="mt-1 text-sm font-medium text-gray-900">{{ $role->created_at->format('d/m/Y H:i') }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- Permissions -->
                    <div class="space-y-4">
                        <h3 class="text-lg font-medium text-gray-900">Permissions associées</h3>
                        <div class="mt-4">
                            ...
                            @else
                            <p class="text-sm text-gray-500">Aucune permission attribuée</p>
                            @endif
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-8 space-y-4">
                    ...
                    <div class="bg-red-50 border-l-4 border-red-400 p-4 rounded">
                        <div class="flex">
                            ...
                            <div class="ml-3">
                                <h3 class="text-sm font-medium text-red-800">Supprimer ce rôle</h3>
                                <div class="mt-2 text-sm text-red-700">
                                    <p>Cette action est irréversible. Soyez certain avant de continuer.</p>
                                </div>
                                <div class="mt-4">
                                    <form action="{{ route('dashboard1.role.destroy', $role->id) }}" method="POST" onsubmit="return confirm('Êtes-vous sûr de vouloir supprimer ce rôle ?');">
                                        @csrf
                                        @method('DELETE')
