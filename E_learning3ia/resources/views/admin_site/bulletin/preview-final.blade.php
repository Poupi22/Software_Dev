...
@section('title', 'Prévisualisation du Bulletin Final')
...
@section('content')
    ...
    <div class="main-content">
        <div class="main-header">
            <div class="container">
                <h1 class="h4 h-md-3 fw-bold mb-1"><i class="fas fa-eye me-2"></i> Prévisualisation du Bulletin Final</h1>
            </div>
        </div>
        ...
        <div class="container">
            <div class="mb-3 d-flex justify-content-between">
                ...
                <a href="{{ route('dashboard.bulletin.download-pdf', array_merge(request()->all(), ['type' => 'final'])) }}"
                    class="btn btn-success">
                    <i class="fas fa-file-pdf me-2"></i> Télécharger PDF Final
                </a>
            </div>

            <!-- Bulletin Final Preview -->
            <div class="bulletin-preview mb-4">
                <!-- En-tête -->
                                    ...
                                    <table class="table table-bordered table-sm mb-0">
                                        ...
                                        <tfoot>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    {{ number_format($bulletinSemestre['assiduite']['presence'], 1) }}%
                                                </td>
                                            </tr>
                                        </tfoot>
                                    </table>
                        ...
                        <div class="card-body">
                            <div class="row align-items-center">
                                <div class="col-md-6 text-center">
                                    ...
                                    <h1
                                        class="{{ $bulletinData['moyenne_annuelle'] >= 10 ? 'text-success' : 'text-danger' }}">
