...
@section('title', 'Prévisualisation du Bulletin')
...
@section('content')
    ...
    <div class="main-content">
        <div class="main-header">
            <div class="container">
                <h1 class="h4 h-md-3 fw-bold mb-1"><i class="fas fa-eye me-2"></i> Prévisualisation du Bulletin</h1>
            </div>
        </div>
        ...
        <div class="container">
            <div class="mb-3 d-flex justify-content-between">
                ...
                <a href="{{ route('dashboard.bulletin.download-pdf', request()->all()) }}" class="btn btn-danger">
                    <i class="fas fa-file-pdf me-2"></i> Télécharger PDF
                </a>
            </div>

            <!-- Bulletin Preview -->
            <div class="bulletin-preview p-0 mb-4">
                <!-- En-tête -->
                <div class="bulletin-header p-3">
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-3 text-end">
                            <p class="mb-0"><strong>Année :</strong> {{ $bulletinData['session']['annee_academique'] }}
                            </p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="bg-light p-3 rounded">
                                ...
                                <p class="mb-0"><strong>Matricule :</strong> {{ $bulletinData['etudiant']['matricule'] }}
                                </p>
                            </div>
                        </div>
                                ...
                                <table class="table table-bordered table-sm">
                                    <thead>
                                        <tr class="table-primary">
                                            ...
                                            <th class="text-center">Norm. ({{ $bulletinData['ponderation']['normale'] }}%)
                                            </th>
                                            @if ($bulletinData['ponderation']['phase'] == 2)
                                                <th class="text-center">Quiz ({{ $bulletinData['ponderation']['quiz'] }}%)
                                                </th>
                                            @endif
                                    ...
                                    <tfoot>
                                        ...
                                        <tr>
                                            ...
                                            <th class="text-center">
                                                <span
                                                    class="badge mention-badge bg-{{ $bulletinData['moyenne_generale'] >= 16 ? 'success' : ($bulletinData['moyenne_generale'] >= 14 ? 'info' : ($bulletinData['moyenne_generale'] >= 12 ? 'primary' : ($bulletinData['moyenne_generale'] >= 10 ? 'warning' : 'danger'))) }}">
