...
<div class="main-content">
    <div class="main-header"><div class="container"><h1>Modifier le Quiz : {{ $quiz->titre }}</h1></div></div>
    <div class="container">
        <div class="card">
            <form action="{{ route('dashboard.quiz.update', $quiz->id) }}" method="POST" id="quiz-form">
                @csrf
                @method('PUT')
